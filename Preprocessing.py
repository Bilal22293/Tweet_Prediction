...
Original file is located at
    https://colab.research.google.com/drive/1zy7lCMDeB5M0cq9fw3al-zwWSEjqEMre
"""
...
os.chdir('/content/gdrive/My Drive/INTER-IIT MID-PREP')
...
df2=pd.read_csv('behaviour_simulation_train_try.csv')
...
filepath = '/content/gdrive/MyDrive/preprocessing/sorted_by_username.csv'
...
df1=pd.read_csv('/content/gdrive/MyDrive/preprocessing/sorted_by_username.csv')
df1
...
filepath = "/content/gdrive/My Drive/preprocessing/behaviour_simulation_train_EDA.csv"
filtered_df.to_csv(filepath,index=False)

"""##Removing Stopwords, Hastags, Emojis and NAN values from our dataset"""

# Read the dataset into a Pandas DataFrame
df = pd.read_csv('behaviour_simulation_train_EDA.csv')
...
filepath = "/content/gdrive/My Drive/preprocessing/EDA_sorted_final_behaviour_dataset.csv"

...
gdown.download('https://drive.google.com/uc?id=17JKvhUtq-BJFF0DOp2FD_mAzlWm8QAnR', 'behaviour_simulation_train.csv', quiet=True)
...
filepath = 'sorted_by_username.csv'
...
df1=pd.read_csv('sorted_by_username.csv')
...
filepath = "behaviour_simulation_train_preprocess.csv"
filtered_df.to_csv(filepath,index=False)

"""##Removing Stopwords, Hastags, Emojis and NAN values from our dataset"""

# Read the dataset into a Pandas DataFrame
df = pd.read_csv('behaviour_simulation_train_preprocess.csv')
...
filepath = "preprocess_final_behaviour_dataset.csv"
